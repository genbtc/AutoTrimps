...
function initializeAllTabs() {
    ...
    createTabs("Buildings", "Controls Settings for Automating Building");
    createTabs("Jobs", "Controls Settings for Automating Worker Hiring");
    createTabs("Upgrades", "Controls Settings for Automating Upgrades");
...
//Buildings
    ...
    createSetting('MaxNursery', 'Max Nurseries', 'Advanced. recommend: -1', 'value', '-1', null, "Buildings");    
