...
//Raiding
    ...
    createSetting('PrestigeRaiding', ['Raid Prestigious Maps','Raid Best Gear Maps'], 'Runs the best prestigious maps for optimal speed in a run. Best used for filler runs', 'multitoggle', 1, null, 'Raid');
